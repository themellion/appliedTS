...
$$\boxed{y_t=f(\beta_0,\beta_1,\ldots,\beta_p;t)+\epsilon}$$
...
$$\boxed{y_t=\mu+\psi_0\epsilon_t+\psi_1\epsilon_{t-1}+\psi_2\epsilon_{t-2}+\ldots}$$
...
library('hwriter')
mydata <- data.frame('Original Values' = c('$y_1$', '$y_2$'), 'First differences' = c(NA, '$z_2$'))
